...
Our heatscore™ feature definitely does not belong in our modeling set, since it's partially derived from our target variable.  We can see some of the ambience variables correlating with certain meal types, along with brunch and breakfast correlating heavily.
